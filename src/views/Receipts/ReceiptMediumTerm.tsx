...
const ReceiptMediumTerm = () => {
	...
	}, [fetchUserTopTracks, userTopTracksMediumTerm]);

	if (isLoading) return <Loading />;

	return <Receipt selectedTimeRange={TimeRange.MediumTerm} />;
};

export default ReceiptMediumTerm;
